...
from ArtistMusic import config, logger, userbot
...
class MongoDB:
    def __init__(self):
        ...
        self.db = self.mongo.ArtistMusic
    ...
    async def get_admins(self, chat_id: int, reload: bool = False) -> list[int]:
        from ArtistMusic.helpers._admins import reload_admins
