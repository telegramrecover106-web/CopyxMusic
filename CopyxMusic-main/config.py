...
RATE_LIMIT_WINDOW = int(os.getenv("RATE_LIMIT_WINDOW", "6"))
MAX_TITLE_LEN = int(os.getenv("MAX_TITLE_LEN", "80"))
PORT = int(os.getenv("PORT", "8080"))

BOT_BRAND = os.getenv("BOT_BRAND", "COPYx MUSIC")
CHANNEL_URL = os.getenv("CHANNEL_URL", "https://t.me/CopymusicOfficial")
ADD_GROUP_URL = os.getenv("ADD_GROUP_URL", "https://t.me/COPYxMUSIC_BOT?startgroup=true")
SUPPORT_URL = os.getenv("SUPPORT_URL", "https://t.me/CopymusicOfficial")
WELCOME_IMAGE = os.getenv("WELCOME_IMAGE", "assets/copyx_welcome.png")
