...
from CopyxMusic import app, config, db, lang
...
async def start(_, message: types.Message):
    ...
    _text = (
        ...
        if private
        else message.lang["start_gp"].format(message.from_user.first_name, message.chat.title or "Group")
    )
...
async def _new_member(_, message: types.Message):
    """Register both basic groups and supergroups; do not auto-leave."""
