...
class YouTube:
    ...
    async def download_via_api(self, link: str, video: bool = False) -> Optional[str]:
        """
        Download audio/video using COPYxMUSIC API (Primary Method).
        ...
        try:
            ...
            logger.info(f"🚀 [API PRIMARY] Trying COPYxMUSIC API for {video_id} (type: {download_type})")
            ...
            if self.artistbots_key:
                ...
                logger.warning("No COPYxMUSIC API key configured!")
                return None
    ...
    async def download_via_cookies(self, video_id: str, video: bool = False) -> Optional[str]:
        ...
        async with self._download_semaphore:
            ...
            logger.info(f"▶️ [YTDLP] Downloading {video_id} with yt-dlp...")
