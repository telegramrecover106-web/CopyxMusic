...
[![Stars](https://img.shields.io/github/stars/elevenyts/CopyxMusic?style=for-the-badge&logo=starship&logoColor=white&color=A960FF&labelColor=0D1117)](https://github.com/elevenyts/CopyxMusic)
[![Forks](https://img.shields.io/github/forks/elevenyts/CopyxMusic?style=for-the-badge&logo=git&logoColor=white&color=7C3AED&labelColor=0D1117)](https://github.com/elevenyts/CopyxMusic)
[![Issues](https://img.shields.io/github/issues/elevenyts/CopyxMusic?style=for-the-badge&logo=github&logoColor=white&color=FF6B6B&labelColor=0D1117)](https://github.com/elevenyts/CopyxMusic/issues)
...
[![Support Group](https://img.shields.io/badge/💬_Support-CopyxMusic-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white&labelColor=0D1117)](https://t.me/Elevenytschats)
...
> **CopyxMusic** is a next-generation Telegram Voice Chat Music Bot engineered for performance, stability, and scale.
...
| `ARTISTBOTS_API_URL` | ⚙️ | COPYxMUSIC API endpoint |
| `ARTISTBOTS_KEY` | ⚙️ | API key — [@COPYxMUSIC_BOT](https://t.me/ArtistApibot) |
...
# Clone repo
git clone https://github.com/elevenyts/CopyxMusic
cd CopyxMusic
...
`Pyrogram` · `PyTgCalls` · `MongoDB` · `Telegram Bot API` · `COPYxMUSIC`

<br>

```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
         Made with ❤️  by  Artist  ·  Powered by COPYxMUSIC
                   © 2026 CopyxMusic · MIT License
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
## COPYxMUSIC production configuration

Required environment variables: `API_ID`, `API_HASH`, `BOT_TOKEN`, `OWNER_ID`, `MONGO_DB_URI`, `SESSION_SECRET`.
Optional assistant sessions: `SESSION_SECRET2`, `SESSION_SECRET3`.
Brand links: `SUPPORT_CHANNEL`, `SUPPORT_CHAT`, `UPDATES_URL`, `OWNER_URL`, `BOT_USERNAME`.
YouTube: yt-dlp is the primary downloader; optional `YOUTUBE_COOKIES` or `COOKIE_URL` can be supplied when YouTube requires authentication.

Playback commands are available to group members; Telegram itself may still require the bot/assistant to have the necessary chat/voice permissions for automatic joining.
