...
async def new_chat_member(_, message: types.Message):
    ...
    for member in message.new_chat_members:
        if member.id == app.id:
            ...
            # Welcome message to the group (public + private)
            uname_display = f"@{chat.username}" if chat.username else "Private"
            welcome_text = f"""<b>𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝗧𝗼 {chat_name}</b>

➖➖➖➖➖➖➖➖➖➖➖

๏ <b>𝗡𝗔𝗠𝗘</b> ➠ {chat_name}
๏ <b>𝗜𝗗</b> ➠ <code>{chat_id}</code>
๏ <b>𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄</b> ➠ {uname_display}
๏ <b>𝐌𝐀𝐃𝐄 𝐁𝐘</b> ➠ <a href="https://t.me/CopymusicOfficial">COPYxMUSIC</a>

➖➖➖➖➖➖➖➖➖➖➖"""
            try:
                from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton
                welcome_btns = InlineKeyboardMarkup([
                    [InlineKeyboardButton("➕ ADD ME TO GROUP", url="https://t.me/COPYxMUSIC_BOT?startgroup=true")],
            ...
            text = f"""<blockquote>🟢 <b>COPYxMUSIC ᴀᴅᴅᴇᴅ ɪɴ ᴀ ɴᴇᴡ ɢʀᴏᴜᴘ</b></blockquote>
...
async def left_chat_member(_, message: types.Message):
    ...
    if message.left_chat_member.id == app.id:
        ...
        text = f"""<blockquote>🔴 <b>COPYxMUSIC ʀᴇᴍᴏᴠᴇᴅ ꜰʀᴏᴍ ᴀ ɢʀᴏᴜᴘ</b></blockquote>
